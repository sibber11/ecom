...
<template>
    <ProfileLayout>
        <div class="col-span-9 space-y-4">
            <article v-if="$page.props.auth.user == null" class="text-center py-4 text-lg text-red-600 font-bold bg-gray-400">
                Login to access the left panel
            </article>
                ...
                <div class="flex items-center justify-between border gap-6 p-4 border-gray-200 rounded">
                    ...
                    <div class="w-1/3">
                        ...
                        <div class="text-gray-500 text-sm">
                            <p>Availability:</p>
                            <span class="text-green-600" v-if="product.resource.quantity > 0">In Stock</span>
                            <span v-else class="text-red-600">Out of Stock</span>
                        </div>
                    </div>
                    <ul>
                        <li v-for="(option, name) in product.options" class="whitespace-nowrap">
...
<!--                    </InertiaLink>-->
            ...
            <article v-if="products.data.length === 0" class="my-10">
