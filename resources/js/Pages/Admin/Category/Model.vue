...
<!--            <p class="text-gray-800">{{ category.description }}</p>-->
            <Link :href="route('admin.categories.edit',category)" class="text-blue-500">
                Edit
            </Link>
            <Link :href="route('admin.categories.destroy',category)" as="button" method="delete" class="text-red-600">
                Delete
            </Link>
        </div>
    </div>
