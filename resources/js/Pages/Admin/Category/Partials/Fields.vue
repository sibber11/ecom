    ...
    <section>
        ...
        <form @submit.prevent="submitForm(method, form, url)" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <SlugInput class="mt-1 block w-full" :url="route('admin.categories.get_slug')" v-model="form.slug" ref="slug_input"/>
            ...
            <div>
                ...
                <SelectModels v-model="form.parent_name" model-name="Category" :url="route('admin.categories.get_names')"/>
            ...
            <div class="flex items-center gap-4">
                ...
                <InertiaLink :href="route('admin.categories.index')" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Cancel
                </InertiaLink>
